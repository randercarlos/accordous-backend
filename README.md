...
Baixe o arquivo zip e o descompacte ou baixe o projeto para sua máquina através do git clone [https://github.com/randercarlos/accordous-backend.git](https://github.com/randercarlos/accordous-backend.git)
